<div id="add_new_dynamic_section" class="modal" data-backdrop="static" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{url('/admin/dynamic-section/submit')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-9">
                            <div class="d-block">
                                <div class="preview-img-square mb-2">
                                    <img class="preview" onclick="document.getElementById('dynamic_section_img').click();" id="preview_dynamic_section_img" src="{{url('/assets/images/default.png')}}" width="100%">
                                </div>
                            </div>
                            <div class="d-block">
                                <div class="custom-file hide">
                                    <input type="file" name="dynamic_section_img" onchange="read_url(event)" class="custom-file-input" id="dynamic_section_img">
