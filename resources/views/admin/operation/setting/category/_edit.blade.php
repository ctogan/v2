            ...
            <form method="POST" action="{{url('/admin/operation/category/update')}}" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Input Banner Description" name="category_name" id="category_name">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="d-block">
                                <div class="preview-img-square mb-2">
                                    <img id="preview_edit_img_category" src="{{url('/assets/images/default.png')}}" width="100%">
                                </div>
                            </div>
                            <div class="d-block">
